...
def setup(u_components, u, v, p, q, bcs, les_model, nut_, scalar_components, V, Q, x_, p_, u_, velocity_update_solver,
          assemble_matrix, homogenize, GradFunction, DivFunction, LESsource, back_flow_facets, mesh_function,
...
def get_solvers(use_krylov_solvers, krylov_solvers, scalar_components, velocity_krylov_solver, pressure_krylov_solver,
                scalar_krylov_solver, bcs, **NS_namespace):
...
def assemble_first_inner_iter(A, a_conv, dt, M, scalar_components, les_model, a_scalar, K, nu, nut_, u_components, LT,
                              KT, b_tmp, b0, x_1, x_2, u_ab, bcs, back_flow_beta, back_flow_facets, K2, wx_,
                              **NS_namespace):
...
def velocity_tentative_solve(ui, A, bcs, x_, x_2, u_sol, b, udiff, **NS_namespace):
